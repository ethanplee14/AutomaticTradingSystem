...
export class AuthenticationApi {
     ...
     * @param auth 
     */
    public async ccpAuthResponsePost (auth?: InlineObject2, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2006;  }> {
        const localVarPath = this.basePath + '/ccp/auth/response';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(auth, "InlineObject2")
        };
